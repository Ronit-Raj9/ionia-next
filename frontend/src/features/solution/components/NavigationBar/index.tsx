        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            <button
              ...
              className="flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium hover:scale-105 transition-all duration-200"
            >
          ...
          <div className="flex flex-wrap items-center gap-4 w-full md:w-auto justify-center md:justify-end">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`p-3 rounded-full transition-all duration-200 hover:shadow-md hover:scale-110 ${
                  readingMode 
              ...
              {/* <button
                ...
                className={`p-3 rounded-full transition-all duration-200 hover:shadow-md hover:scale-110 ${
                  darkMode 
                    ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900 dark:text-yellow-300 shadow-md' 
                    : 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300'
                }`}
