...
export const NotVisitedIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <div className={`${className} border border-gray-300 bg-white rounded-sm`} />
);
...
export const AnsweredAndMarkedIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
  <div className={`${className} relative`}>
    <div className="absolute inset-0 bg-purple-500 rounded-full" />
    <div className="absolute bottom-0 left-0 w-2 h-2 bg-green-500 rounded-sm" />
  </div>
);
