...
import { formatRemainingTime } from '../utils/authUtils';
...
const SessionWarning: React.FC<SessionWarningProps> = ({
  ...
  const { checkSessionStatus } = useAuthStore();
  const { timeRemaining } = checkSessionStatus();
          ...
          <div className="container mx-auto flex items-center justify-between">
            <div className="flex items-center">
              ...
              <p className="text-sm font-medium text-yellow-800">
                Session expires in {formatRemainingTime(timeRemaining)}
              </p>
            </div>
