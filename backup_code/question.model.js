...
const questionSchema = new mongoose.Schema(
    {
        ...
        subject: { 
            ...
            trim: true,
            enum: {
                values: ['general_test', 'english', 'biology', 'physics', 'chemistry', 'mathematics'],
        ...
        section: { 
            ...
            required: [
                function() { 
                    // Make section required for specific subjects only
                    return ['physics', 'chemistry', 'mathematics', 'general_test', 'english', 'biology'].includes(this.subject?.toLowerCase());
                },
                'Section is required for this subject'
            ],
            validate: {
                validator: function(value) {
                    // Skip validation if no subject selected
                    if (!this.subject) return true;
                    
                    const subject = this.subject.toLowerCase();
                    
                    // Define valid sections for each subject
                    const validSections = {
                    ...
                    // Check if the section is valid for the selected subject
