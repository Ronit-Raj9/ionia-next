...
import { TestAnalytics, TestItem, QuestionItem } from '../types/analytics';
...
export class TestService {
  ...
  static async getTests(filters: TestFilters = {}) {
    try {
      ...
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/tests?${queryParams.toString()}`, { method: 'GET' });
      return response;
    } catch (error) {
  ...
  static async getTestById(testId: string): Promise<Test> {
    try {
      const response = await fetchWithAuth<APIResponse<Test>>(`${API_BASE}/tests/${testId}`, { method: 'GET' });
  ...
  static async createTest(testData: CreateTestData): Promise<Test> {
    try {
      const response = await fetchWithAuth<APIResponse<Test>>(`${API_BASE}/tests`, {
        method: 'POST',
  ...
  static async updateTest(testId: string, updateData: Partial<CreateTestData>): Promise<Test> {
    try {
      const response = await fetchWithAuth<APIResponse<Test>>(`${API_BASE}/tests/${testId}`, {
        method: 'PATCH',
  ...
  static async deleteTest(testId: string): Promise<void> {
    try {
      await fetchWithAuth(`${API_BASE}/tests/${testId}`, { method: 'DELETE' });
    } catch (error) {
   ...
   */
  static async getTestForAttempt(testId: string): Promise<TestForAttempt> {
    try {
      const response = await fetchWithAuth<APIResponse<TestForAttempt>>(`${API_BASE}/tests/${testId}/attempt`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getTestAnalysis(attemptId: string, paperId?: string): Promise<TestAnalysis> {
    try {
      ...
      const response = await fetchWithAuth<APIResponse<TestAnalysis>>(`${API_BASE}/attempted-tests/analysis?${params.toString()}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getTimeAnalytics(testId: string) {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/time-analytics?testId=${testId}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getErrorAnalysis(testId: string) {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/error-analysis?testId=${testId}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getNavigationPatterns(testId: string) {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/navigation-patterns?testId=${testId}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getDifficultyAnalysis(testId: string) {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/difficulty-analysis?testId=${testId}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getInteractionMetrics(testId: string) {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/interaction-metrics?testId=${testId}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getPerformanceTrends(testId?: string) {
    try {
      ...
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/performance-trends${params}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getSubjectAnalysis() {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/subject-analysis`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async getSolutions(attemptId: string) {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/solutions/${attemptId}`, { method: 'GET' });
      return response.data;
    } catch (error) {
  ...
  static async deleteTestAttempt(attemptId: string) {
    try {
      const response = await fetchWithAuth<APIResponse<any>>(`${API_BASE}/attempted-tests/delete/${attemptId}`, { method: 'DELETE' });
      return response.data;
    } catch (error) {
   ...
   */
  static async getTestAnalytics(): Promise<TestAnalytics> {
    try {
      const response = await fetchWithAuth<APIResponse<TestAnalytics>>(`${API_BASE}/analytics/tests`, { method: 'GET' });
      return response.data;
    } catch (error) {
